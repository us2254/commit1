<h1><?php echo erTranslationClassLhTranslation::getInstance()->getTranslation('faq/edit','Edit Tip');?> - <?php echo htmlspecialchars($departament->tips)?></h1>
...
<form action="" method="post">
    ...
    <div class="btn-group" role="group" aria-label="...">
         ...
         <?php if ($departament->id != 1 && $currentUser->hasAccessTo('lhfaq','delete') && $departament->can_delete == true ) : ?><input type="submit" class="btn btn-danger" name="Delete_departament" onclick="return confirm('<?php echo erTranslationClassLhTranslation::getInstance()->getTranslation('faq/departments','Are you sure?');?>')" value="<?php echo erTranslationClassLhTranslation::getInstance()->getTranslation('system/buttons','Delete tip');?>"/><?php endif;?>
	</div>
