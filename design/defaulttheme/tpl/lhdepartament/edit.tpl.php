...
<h1><?php echo erTranslationClassLhTranslation::getInstance()->getTranslation('department/edit','Edit domain');?> - <?php echo htmlspecialchars($departament->name)?></h1>
...
<form action="" method="post">
    ...
    <div class="btn-group" role="group" aria-label="...">
         ...
         <?php if ($departament->id != 1 && $currentUser->hasAccessTo('lhdepartament','delete') && $departament->can_delete == true ) : ?><input type="submit" class="btn btn-danger" name="Delete_departament" onclick="return confirm('<?php echo erTranslationClassLhTranslation::getInstance()->getTranslation('department/departments','Are you sure?');?>')" value="<?php echo erTranslationClassLhTranslation::getInstance()->getTranslation('system/buttons','Delete domain');?>"/><?php endif;?>
	</div>
...
<h1><?php echo erTranslationClassLhTranslation::getInstance()->getTranslation('department/edit','Edit Tip');?> - <?php echo htmlspecialchars($departament->tips)?></h1>
...
<form action="" method="post">
    ...
    <div class="btn-group" role="group" aria-label="...">
         ...
         <input type="submit" class="btn btn-default" name="Update_departament" value="<?php echo erTranslationClassLhTranslation::getInstance()->getTranslation('system/buttons','Update');?>"/>
         <input type="submit" class="btn btn-default" name="Cancel_departament" value="<?php echo erTranslationClassLhTranslation::getInstance()->getTranslation('system/buttons','Cancel');?>"/>
         <?php if ($departament->id != 1 && $currentUser->hasAccessTo('lhdepartament','delete') && $departament->can_delete == true ) : ?><input type="submit" class="btn btn-danger" name="Delete_departament" onclick="return confirm('<?php echo erTranslationClassLhTranslation::getInstance()->getTranslation('department/departments','Are you sure?');?>    ')" value="<?php echo erTranslationClassLhTranslation::getInstance()->getTranslation('system/buttons','Delete tip');?>"/><?php endif;?>
	</div>
