...
<li><a href="<?php echo erLhcoreClassDesign::baseurl('translation/configuration')?>"><?php echo erTranslationClassLhTranslation::getInstance()->getTranslation('system/configuration','Tips Configuration');?></a></li>
<?php endif;?>